const tpl = `
			<form class="auth__form form">
					...
					{{> input id="auth-name"  name="first_name" classNames="form__input" type="text"  minlength="1" }}
					...
					{{> input id="auth-surname"  name="second_name" classNames="form__input" type="text"  minlength="1" }}
