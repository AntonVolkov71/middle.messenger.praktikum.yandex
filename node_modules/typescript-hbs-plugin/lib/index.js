...
class CSSConfigurationManager {
    constructor() {
        ...
        this._configuration = CSSConfigurationManager.defaultConfiguration;
    }
...
CSSConfigurationManager.defaultConfiguration = {
...
class HtmlPlugin {
    ...
    create(info) {
        if (info.languageService[hbsHtmlPluginMarker]) {
            // Already decorated
        ...
        const styledLanguageService = new api_1.StyledTemplateLanguageService(this._typescript, new CSSConfigurationManager(), new virtual_document_provider_1.CssDocumentProvider(this.htmlLanguageService), logger);
        ...
        const languageService = (0, typescript_template_language_service_decorator_1.decorateWithTemplateLanguageService)(this._typescript, info.languageService, info.project, htmlTemplateLanguageService, this.getTemplateSettings(this._config, this._virtualDocumentProvider), { logger });
        languageService[hbsHtmlPluginMarker] = true;
    ...
    get htmlLanguageService() {
        if (!this._htmlLanguageService) {
            this._htmlLanguageService = (0, vscode_html_languageservice_1.getLanguageService)();
        }
    ...
    getTemplateSettings(config, provider) {
        return {
            ...
            getSubstitutions: (templateString, spans) => {
                return (0, substitutions_1.getSubstitutions)(this._typescript, this.htmlLanguageService, provider, templateString, spans);
            },
        };
    }
}
module.exports = function factory(mod) {
